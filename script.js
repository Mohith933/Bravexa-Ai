document.addEventListener("DOMContentLoaded", function () {
  ...
  async function generateAIResponse(userMessage) {
    ...
    switch (intent) {
      case "greeting":
        response = `<h2>👋 Hello!</h2><p>I’m <strong>Bravexa AI</strong> — your creative workspace assistant.</p>`;
        break;
      case "motivate":
        response = `<h2>🚀 Motivation Boost</h2><p>Every small step builds your mastery. Keep moving forward! 💪</p>`;
        break;
      default:
        response = `<p>✨ I’m Bravexa AI — your workspace friend. Try “Generate leave letter” or “Official email”.</p>`;
    }
